...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'debugger.data';
    var REMOTE_PACKAGE_BASE = 'debugger.data';
...
Module['FS_createPath']('/assets', 'shaders', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_debugger.data');

    };
    Module['addRunDependency']('datafile_debugger.data');
 ...
 loadPackage({"files": [{"audio": 0, "start": 0, "crunched": 0, "end": 285388, "filename": "/assets/fonts/SourceCodeVariable-Roman.ttf"}, {"audio": 0, "start": 285388, "crunched": 0, "end": 285759, "filename": "/assets/shaders/texture_atlas.frag.glsl"}, {"audio": 0, "start": 285759, "crunched": 0, "end": 285919, "filename": "/assets/shaders/texture_atlas.vert.glsl"}], "remote_package_size": 285919, "package_uuid": "32c74558-74ab-4794-b193-66d5d71cb02d"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'debugger.wast';
...
var real__deinit = asm["_deinit"]; asm["_deinit"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__deinit.apply(null, arguments);
};
...
var real__set_text = asm["_set_text"]; asm["_set_text"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__set_text.apply(null, arguments);
};
...
var _deinit = Module["_deinit"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_deinit"].apply(null, arguments) };
...
var _resize = Module["_resize"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_resize"].apply(null, arguments) };
var _sbrk = Module["_sbrk"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_sbrk"].apply(null, arguments) };
var _set_text = Module["_set_text"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_set_text"].apply(null, arguments) };
